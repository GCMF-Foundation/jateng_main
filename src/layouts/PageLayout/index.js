...
function pageLayout(props) {
  ...
  const slogan =
    "Berjuang untuk sukses tanpa kerja keras seperti mencoba memanen ketika kamu belum menanam.";
  const copyright = "2021 Jawa Tengah Blended Learning - Didukung oleh ";
